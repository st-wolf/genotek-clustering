...
class Processor:
	"""
	Класс Processor выполняет основыные действия по обработке данных. Он
	...
	избежании действий над пустым состоянимем, важно запускать методы в
	...
	def reduce_dimension(self):
		"""
		Выполнение опрерации понижения размерности над данными. Преобразованные
	...
	def intra_cluster_average(self):
		...
		между кластерами дает информацию о качестве кластеризации.
		"""
